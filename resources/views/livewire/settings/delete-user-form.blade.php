...
<section class="mt-10 space-y-6">
    <div class="relative mb-5">
        ...
        <flux:subheading>{{ __('Xóa tài khoản và mọi dữ liệu') }}</flux:subheading>
    </div>
    ...
    <flux:modal name="confirm-user-deletion" :show="$errors->isNotEmpty()" focusable class="max-w-lg">
        <form method="POST" wire:submit="deleteUser" class="space-y-6">
            <div>
                ...
                <flux:subheading>
                    {{ __('Một khi tài khoản của bạn bị xóa, tất cả tài nguyên và dữ liệu của nó sẽ bị xóa vĩnh viễn. Vui lòng nhập mật khẩu của bạn để xác nhận rằng bạn muốn xóa vĩnh viễn tài khoản của mình.') }}
                </flux:subheading>
            </div>
