        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="mb-6">
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Mô tả ngắn:</h2>
                        <p class="text-gray-700 dark:text-gray-300 leading-relaxed">{{ $post->short_description }}</p>
                    </div>
                    @endif
